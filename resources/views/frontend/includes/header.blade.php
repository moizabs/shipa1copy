<head>
    <link rel="preload" as="image" href="{{ asset('public/frontend/images/logo/LOGO NEW-2.webp') }}" type="image/webp">
</head>
<style>
    .active {
...
<header class="tj-header-section" id="header-sticky">
                    ...
                    <div class="logo-area">
                        <div class="logo-box">
                            <a href="{{ route('welcome') }}" aria-label="Home" title="Home"><img
                                    src="{{ asset('public/frontend/images/logo/LOGO NEW-2.webp') }}" width="200"
                        ...
                        <div class="header-topbar">
                            <div class="topbar-content-area d-flex flex-wrap align-items-center justify-content-start">
                                <div class="header-content-right mr-4">
                                    <span><i class="fa-regular fa-mobile-screen fa-bounce fa-lg"
                                            style="color:#8fc445"></i>
                                        <a href="tel: 1 (844) 474-4721" class="text-white nav-num-hover"
                                            aria-label="Call 1 (844) 474-4721" title="Call 1 (844) 474-4721">1 (844)
                                            474-4721</a>
                                    </span>
                                </div>
                                <div class="header-content-left me-auto">
                                    <span><i class="fa-regular fa-envelope fa-bounce fa-lg" style="color:#8fc445"></i>
                                        <a href="mailto:shawntransport@shipa1.com" class=text-white
                                            aria-label="Email shawntransport@shipa1.com"
                                            title="Email shawntransport@shipa1.com">
                                            shawntransport@shipa1.com</a></span>
                                </div>
                                        ...
                                        <ul class="list-gap social-list">
                                            <li>
                                                <a href=https://www.facebook.com/shipa1autotransport
                                                    aria-label="Visit our Facebook" title="Visit our Facebook"><i
                                                        class="fa-brands fa-facebook-f"></i></a></li>
                                            <li>
                                               <a href=https://www.youtube.com/@shipA1autotransport
                                                    aria-label="Visit our YouTube" title="Visit our YouTube"><i
                                                        class="fa-brands fa-youtube"></i></a></li>
                                            <li>
                                               <a href=https://www.linkedin.com/in/shipa1-transport/
                                                    aria-label="Visit our LinkedIn" title="Visit our LinkedIn">
                                                    <i class="fa-brands fa-linkedin-in"></i>
                                               </a>
                                            </li>
                                            <li>
                                               <a href=https://wa.me/+14107184031 aria-label="Contact us on WhatsApp"
                                                    title="Contact us on WhatsApp"><i
                                                        class="fa-brands fa-whatsapp"></i>
                                               </a>
                                            </li>
                                            <li>
                                               <a href=https://www.instagram.com/shipa1_transport/
                                                    aria-label="Visit our Instagram" title="Visit our Instagram"><i
                                                        class="fa-brands fa-instagram"></i>
                                              </a>
                                            </li>
                                            <li>
                                               <a href=https://www.pinterest.com/shipa10231/
                                                    aria-label="Visit our Pinterest" title="Visit our Pinterest"><i
                        ...
                        <div class="header-content d-flex flex-wrap align-items-center justify-content-between">
                            <div class="mobile-logo-area d-lg-none">
                                <a href="{{ route('welcome') }}" aria-label=Home title=Home>
                                    <img src="{{ asset('public/frontend/images/logo/LOGO NEW-2.webp') }}" width="200"
                                        height="70" loading=lazy alt=Logo>
                                </a>
                            </div>
                            <div class="tj-main-menu d-lg-block d-none text-end" id=main-menu>
                                <ul class="main-menu">
                                    @php $navbars = App\Models\Menu::where('status',1)->orderBy('id', 'ASC')->get(); @endphp @foreach ($navbars as $navbar)
                                        @if ($navbar->id == 1)
                                            <li class="ab-gap">
                                        ...
                                        @endif
                                        @endforeach @foreach ($navbars as $navbar)
                                            @if ($navbar->id == 2)
                                                <li class="ab-gap">
                                                    <a href="{{ route('quote.form.combine') }}"
                                                        class="{{ Request::routeIs('quote.form.combine') ? ' active' : '' }}">
                                                        {{ $navbar->menu_name }}</a>
    ...
    <a class=title href="{{ route('form.vehicle.roro') }}">Roro Transportation</a>
                                                    ...
                                                    <ul class="list-gap sub-menu-list">
                                                        <div class=row>
                                                            <div class="col-sm-12 col-md-12 col-lg-4 bd-l bd-r">
                                                                <h4 class="mb-3 ul-child-custom-heading"
                                                                    title="Vehicle Transportation">
                                                                    Vehicle Transportation
                                                                </h4>
                                                                <li>
                                                                    <a class=title
                                                                        href="{{ route('form.vehicle.atv_utv') }}"
                                                                        title="Atv Utv Transport"
                                                                        aria-label="Atv Utv Transport">
                                                                        Atv Utv Transport
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a class=title
                                                                        href="{{ route('form.vehicle.car') }}"
                                                                        title="Car Transport"
                                                                        aria-label="Car Transport">
                                                                        Car Transport
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a class=title
                                                                        ...
                                                                        title="Golf Cart Transport"
                                                                        aria-label="Golf Cart Transport">
                                                                        Golf Cart Transport
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a class=title
                                                                        ...
                                                                        aria-label="Motorcycle Transport">
                                                            ...
                                                            <div class="col-sm-12 col-md-12 col-lg-4 bd-r">
                                                                ...
                                                                <li>
                                                                    <a class=title
                                                                        ...
                                                                        title="Commercial Truck Transport"
                                                                        aria-label="Commercial Truck Transport">
                                                                ...
                                                                <li>
                                                                    <a class=title
                                                                        ...
                                                                        aria-label="Construction Transport">
                                                                ...
                                                                <li>
                                                                    <a class=title
                                                                        href="{{ route('frontend.forms.excavator') }}"
                                                                        title="Excavator Transport"
                                                                        aria-label="Excavator Transport">
                                                                        Excavator Transport
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a class=title
                                                                        ...
                                                                        aria-label="Farm Transport">
                                                                        Farm Transport
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a class=title
                                                                        href="{{ route('frontend.forms.rv_transport') }}"
                                                                        title="RV Transport"
                                                                        aria-label="RV Transport">
                                                                        RV Transport
                                                                    </a>
                                                                </li>
                                                            </div>
                                                            <div class="col-sm-12 col-md-12 col-lg-4">
                                                                ...
                                                                <li>
                                                                    <a class=title
                                                                        href="{{ route('frontend.forms.hazmattransport') }}"
                                                                        title="Hazmat Transport"
                                                                        aria-label="Hazmat Transport">
                                                                        Hazmat Transport
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a class=title
                                                                        ...
                                                                        aria-label="Dry Van Transport">
                                                                        Dry Van Transport
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a class=title
                                                                        href="{{ route('frontend.forms.reefertrucking') }}"
                                                                        title="Reefer Trucking"
                                                                        aria-label="Reefer Trucking">
                                                                        Reefer Trucking
                                                                    </a>
                                                                </li>
                                                                ...
                                                                <li>
                                                                    <a class=title
                                                                        href="{{ route('form.vehicle.roro') }}"
                                                                        title="Roro Transportation"
                                                                        aria-label="Roro Transportation">
                                                                        Roro Transportation
                                                                    </a>
                                                                </li>
                                                            </div>
                                            ...
                                            @endphp @foreach ($navbars as $navbar)
                                                @if ($navbar->id == 3)
                                                    <li class="current-menu-item menu-item-has-children">
                                                        ...
                                                        <ul class="list-gap sub-menu-list">
                                                            <div class=row>
                                                                <div class="col-sm-12 col-md-12 col-lg-4 bd-l bd-r">
                                                                    <h4 class="mb-3 ul-child-custom-heading">Vehicle
                                                                        Transportation</h4>
                                                                    ...
                                                                    <li>
                                                                        <a class=title
                                                                            ...
                                                                            aria-label="Car Transport Service"
                                                                            title="Click to learn more about Car Transport Service">
                                                                    ...
                                                                    <li>
                                                                        <a class=title
                                                                            ...
                                                                            aria-label="Motorcycle Transport Service"
                                                                            title="Click to learn more about Motorcycle Transport Service">
                                                                    ...
                                                                    <li>
                                                                        <a class=title
                                                                            ...
                                                                            aria-label="ATV/UTV Transport Service"
                                                                            title="Click to learn more about ATV/UTV Transport Service">
                                                                    ...
                                                                    <li>
                                                                        <a class=title
                                                                            ...
                                                                            aria-label="Golf Cart Transport Service"
                                                                            title="Click to learn more about Golf Cart Transport Service">
                                                                            Golf Cart Transport Service
                                                                        </a>
                                                                    </li>
                                                                </div>
                                                                <div class="col-sm-12 col-md-12 col-lg-4 bd-r">
                                                                    <h4 class="mb-3 ul-child-custom-heading">Heavy
                                                                        Equipment</h4>
                                                                    @foreach ($services as $service)
                                                                    ...
                                                                    <li>
                                                                        <a class=title
                                                                            ...
                                                                            aria-label="Boat Transport Services"
                                                                            title="Click to learn more about Boat Transport Services">
                                                                    ...
                                                                    <li>
                                                                        <a class=title
                                                                            ...
                                                                            aria-label="Construction Equipment Services"
                                                                            title="Click to learn more about Construction Equipment Services">
                                                                    ...
                                                                    <li>
                                                                        <a class=title
                                                                            ...
                                                                            aria-label="Commercial Truck Transport"
                                                                            title="Click to learn more about Commercial Truck Transport">
                                                                            Commercial Truck Transport
                                                                        </a>
                                                                    </li>
                                                                    <li>
                                                                        <a class=title
                                                                            ...
                                                                            aria-label="Excavator Transport Services"
                                                                            title="Click to learn more about Excavator Transport Services">
                                                                    ...
                                                                    <li>
                                                                        <a class=title
                                                                            ...
                                                                            aria-label="Farm Transport Services"
                                                                            title="Click to learn more about Farm Transport Services">
                                                                    ...
                                                                    <li>
                                                                        <a class=title
                                                                            ...
                                                                            aria-label="Heavy Equipment Services"
                                                                            title="Click to learn more about Heavy Equipment Services">
                                                                    ...
                                                                    <li>
                                                                        <a class=title
                                                                            ...
                                                                            aria-label="RV Transport Services"
                                                                            title="Click to learn more about RV Transport Services">
                                                                            RV Transport Services
                                                                        </a>
                                                                    </li>
                                                                </div>
                                                                <div class="col-sm-12 col-md-12 col-lg-4">
                                                                    <h4 class="mb-3 ul-child-custom-heading">Freight
                                                                        Transportation</h4>
                                                                    @foreach ($services as $service)
                                                                    ...
                                                                    <li>
                                                                        <a class=title
                                                                            ...
                                                                            aria-label="Dry Van Transport"
                                                                            title="Click to learn more about Dry Van Transport">
                                                                            Dry Van Transport
                                                                        </a>
                                                                    </li>
                                                                    <li>
                                                                        <a class=title
                                                                            ...
                                                                            aria-label="Hazmat Transport"
                                                                            title="Click to learn more about Hazmat Transport">
                                                                            Hazmat Transport
                                                                        </a>
                                                                    </li>
                                                                    <li>
                                                                        <a class=title
                                                                            ...
                                                                            aria-label="Reefer Transport"
                                                                            title="Click to learn more about Reefer Transport">
                                                                            Reefer Transport
                                                                        </a>
                                                                    </li>
                                                                    <h4 class="mb-3 ul-child-custom-heading">RORO</h4>
                                                                    ...
                                                                    <li>
                                                                        <a class=title
                                                                            ...
                                                                            aria-label="Roro Shipping International"
                                                                            title="Click to learn more about Roro Shipping International">
                                                    ...
                                                    @if ($navbar->id == 4)
                                                        <li class=ab-gap>
                                                            ...
                                                            <ul class="list-gap sub-menu-list sub-menu-list-2">
                                                                <div class=row>
                                                                    <div
                                                                        class="col-sm-12 col-md-12 col-lg-6 bd-l bd-r">
                                                                        <h4 class="mb-3 ul-child-custom-heading">
                                                                            Auction Transport Service</h4>
                                                                        <li>
                                                                            <a class=title
                                                                                href="{{ route('autoAuction') }}"
                                                                                title="Auto Auction Transport"
                                                                                aria-label="Auto Auction Transport">
                                                                        ...
                                                                        <li>
                                                                            <a class=title
                                                                                ...
                                                                                title="Heavy Auction Transport"
                                                                                aria-label="Heavy Auction Transport">
                                                                    ...
                                                                    <div
                                                                        class="col-sm-12 col-md-12 col-lg-6 bd-l bd-r">
                                                                        <h4 class="mb-3 ul-child-custom-heading">
                                                                            Freight Transport Solution</h4>
                                                                        <li>
                                                                            <a class=title
                                                                                href="{{ route('thirdPartyLogistics') }}"
                                                                                title="Freight Logistics Solution"
                                                                                aria-label="Freight Logistics Solution">
                            ...
                            <div class="header-menu-select d-flex align-items-center justify-content-end">
                                <div class="tj-header-button d-none d-lg-block">
                                    <a class=tj-header-btn href="{{ route('quote.form.combine') }}"
                                        title="Get a quote for your needs" aria-label="Get a quote for your needs">Get
                                        Quote<i class=flaticon-right-1></i>
                                    </a>
                                </div>
