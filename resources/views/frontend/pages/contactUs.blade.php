...
@section('meta_description',
    'Need assistance or have a question? Our team is ready to help! Contact us now and let’s
    get the conversation started. We’d love to hear from you!')
@section('content')
    <style>
        .is-invalid {
            border-color: #ff0019;
            ...
            <div class="row align-items-center">
                <div class="col-lg-7" data-sal="slide-right" data-sal-duration="800">
                    ...
                    <div class="tj-animate-form d-flex align-items-center">
                        <form id="contactForm" class="animate-form contactForm"
                            action="{{ route('contact_messages.store') }}" method="POST">
                            @csrf
                            <div class="row">
                ...
                <div class="col-lg-5" data-sal="slide-left" data-sal-duration="800">
                    <div class="google-map">
                        <iframe
                            ...
                            title="Google Maps location of [your specific location or purpose]" loading="lazy"
