...
@section('meta_description', 'Streamline your purchasing process with our user-friendly order form. Easily submit your
    requests and enjoy a hassle-free experience today!')
@section('canonical')
...
@section('content')
    ...
    <section>
        ...
        <div class="container-fluid" style="background-color: #062e39">
            <div class="row">
                @if (session('success'))
                ...
                <div class="col-lg-12" data-sal="slide-down" data-sal-duration="800">
                    <div class="col-md-6 py-4 my-5 mx-auto"
                        style=" background: #062e39d4; border-radius: 25px;  box-shadow: 0 0 20px 6px rgb(255 255 255 / 50%); "
                        data-bg-image="">
                        <h3 class="title text-white">Enter Details</h3>
                        <form action="{{ route('get.order.details') }}" method="post" class="rd-mailform"
                            ...
                            <div data-mdb-input-init class="form-outline mb-4">
                                ...
                                <label class="form-label text-white" for="form3Example3">Order #.</label>
                            </div>
                            <div data-mdb-input-init class="form-outline mb-4">
