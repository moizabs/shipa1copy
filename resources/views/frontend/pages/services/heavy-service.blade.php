...
@section('meta_description', 'Need a heavy equipment transporter? Ship A1 specializes in secure and professional heavy
    equipment shipping across the USA. Contact us now!')
@section('canonical')
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-12 order-sm-1 order-md-2 order-2 d-flex align-items-center justify-content-center sal-animate"
                    ...
                    <div class="mt-4 rounded">
                        <div class="image-box">
                            <img class="rounded" src="{{ asset('public/frontend/images/project/tuxpi.com.1729.webp') }}"
                                alt="Image">
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-12 order-sm-1 order-md-1 order-2 d-flex align-items-center justify-content-center sal-animate"
                    ...
                    <div class="mt-4 rounded">
                        <div class="image-box">
                            <img class="rounded" src="{{ asset('public/frontend/images/project/tuxpi.com.17292466.webp') }}"
                                alt="Image">
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-12 order-sm-1 order-md-2 order-2 d-flex align-items-center justify-content-center sal-animate"
                    ...
                    <div class="mt-4 rounded">
                        <div class="image-box">
                            <img class="rounded" src="{{ asset('public/frontend/images/project/tuxpi.commmm.webp') }}"
                                alt="Image">
                        </div>
                    </div>
                </div>
                                ...
                                <div class="card-2 mb-3">
                                    <div class="row g-0">
                                        <div class="col-sm-6 d-flex align-items-center justify-content-center">
                                            <img src="{{ asset('public/frontend/images/slider/Heavy Equipment on Lowboy Trailer.webp') }}"
                            ...
                            <div class="col-lg-12">
                                <div class="card-2 mb-3">
                                    <div class="row g-0">
                                        ...
                                        <div class="col-sm-6 d-flex align-items-center justify-content-center">
                                            <img src="{{ asset('public/frontend/images/slider/Heavy Equipment on Flatbed Trailer.webp') }}"
                                                class="img-fluid rounded-start"
                                                style="height: 100%; background-size: cover; background-position: center;"
                                                alt="...">
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card-2 mb-3">
                                    <div class="row g-0">
                                        <div class="col-sm-6 d-flex align-items-center justify-content-center">
                                            <img src="{{ asset('public/frontend/images/slider/Heavy Equipment on dropdeck Trailer.webp') }}"
                                                class="img-fluid rounded-start"
                                                style="height: 100%; background-size: cover; background-position: center;"
                                                alt="...">
                                        </div>
                            ...
                            <div class="col-lg-12">
                                <div class="card-2 mb-3">
                                    <div class="row g-0">
                                        ...
                                        <div class="col-sm-6 d-flex align-items-center justify-content-center">
                                            <img src="{{ asset('public/frontend/images/slider/Heavy Equipment on Gooseneck Trailer.webp') }}"
                                                class="img-fluid rounded-start"
                                                style="height: 100%; background-size: cover; background-position: center;"
                                                alt="...">
                                        </div>
