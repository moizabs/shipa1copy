...
@section('meta_description',
    'ShipA1 makes each transport journey easy, secure, and well-monitored. Connect with us, learn about services, and
    book a quote today.')
@section('canonical')
        ...
        <div class="container">
                ...
                <div class="col-lg-4 col-md-6" data-sal="slide-up" data-sal-duration="800" data-sal-delay="300">
                    <div class="service-item-three">
                        ...
                        <div class="overlay">
                            <div class="row justify-content-center align-items-center">
                                <div class="col-12 text-center mb-3">
                                    <svg fill="#ffffff" width="75px" height="75px" viewBox="0 0 50 50"
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6" data-sal="slide-up" data-sal-duration="800" data-sal-delay="300">
                    <div class="service-item-three">
                        <div class="service-image">
                            <img loading="lazy" src="{{ asset('frontend/images/service/Golf.webp') }}"
                                alt="Image" />
                        </div>
                        <div class="overlay">
                            <div class="row justify-content-center align-items-center">
                                ...
                                <div class="col-12 text-center"><a class="fs-5"
                                        href="{{ route('frontend.pages.services.golf-cart-service') }}"><button
                                            class="tj-submit-btn fs-6">Golf Cart Shipping Service<i
                ...
                <div class="col-lg-4 col-md-6" data-sal="slide-up" data-sal-duration="800" data-sal-delay="300">
                    <div class="service-item-three">
                        ...
                        <div class="overlay">
                            <div class="row justify-content-center align-items-center">
                                <div class="col-12 text-center mb-3">
                                    <svg fill="#ffffff" height="75px" width="89px" version="1.1" id="Layer_1"
                                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                ...
                                <div class="col-12 text-center"><a class="fs-5"
                                        href="{{ route('frontend.pages.services.boat-service') }}"><button
                                            class="tj-submit-btn fs-6">Boat Transport Services<i
                                                class="fa fa-arrow-left"></i></button></a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-6" data-sal="slide-up" data-sal-duration="800" data-sal-delay="300">
                    <div class="service-item-three">
                        <div class="service-image">
                            <img loading="lazy" src="{{ asset('frontend/images/service/Construction.webp') }}"
                                alt="Image" />
                        </div>
                        <div class="overlay">
                            <div class="row justify-content-center align-items-center">
                                <div class="col-12 text-center mb-3">
                                    <svg version="1.1" id="Icons" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        xml:space="preserve" width="82px" height="82px" fill="#ffffff"
                                        stroke="#ffffff">
                                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                        <g id="SVGRepo_iconCarrier">
                                            ...
                                            <line class="st0" x1="3" y1="11" x2="3"
                                                y2="14"></line>
                                            <path class="st0"
                                                d="M18,18l-1.7-8.3c-0.2-1-1-1.7-2-1.7H11c-1.1,0-2,0.9-2,2v4"></path>
                                            <path class="st0"
                                                d="M31,26h-5.6c-0.9,0-1.8-0.4-2.4-1l0,0c-0.6-0.6-1-1.5-1-2.4V17l8,9"></path>
                                            <circle class="st0" cx="4" cy="23" r="3"></circle>
                                            <circle class="st0" cx="16" cy="23" r="3"></circle>
                                            <polyline class="st0" points="19,8 12,8 12,15 "></polyline>
                                            <line class="st0" x1="13.2" y1="22" x2="6.8"
                                                y2="22"></line>
                                            <path class="st0"
                                                d="M1.5,21.3C1.2,21,1,20.5,1,20v-4c0-1.1,0.9-2,2-2h6l9,4h4"></path>
                                        </g>
                                    </svg>
                                </div>
                                <div class="col-12 text-center text-white mb-3">
                                ...
                                <div class="col-12 text-center"><a class="fs-5"
                                        href="{{ route('frontend.pages.services.construction-service') }}"><button
                                            class="tj-submit-btn fs-6"> Equipment Services<i
                                                class="fa fa-arrow-left"></i></button></a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6" data-sal="slide-up" data-sal-duration="800" data-sal-delay="300">
                    <div class="service-item-three">
                        <div class="service-image">
                            <img loading="lazy" src="{{ asset('frontend/images/service/Commercial.webp') }}"
                                alt="Image" />
                        </div>
                        <div class="overlay">
                            <div class="row justify-content-center align-items-center">
                                ...
                                <div class="col-12 text-center"><a class="fs-5"
                                        href="{{ route('frontend.pages.services.commercial-service') }}"><button
                                            class="tj-submit-btn fs-6"> Equipment Services<i
                                                class="fa fa-arrow-left"></i></button></a>
                                </div>
                            </div>
                ...
                <div class="col-lg-4 col-md-6" data-sal="slide-up" data-sal-duration="800" data-sal-delay="300">
                    <div class="service-item-three">
                        <div class="service-image">
                            <img loading="lazy" src="{{ asset('frontend/images/service/Excavator.webp') }}"
                                alt="Image" />
                        </div>
                        <div class="overlay">
                            <div class="row justify-content-center align-items-center">
                                <div class="col-12 text-center mb-3">
                                    <svg fill="#ffffff" height="80px" width="80px" version="1.1" id="Layer_1"
                                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        viewBox="0 0 511.985 511.985" xml:space="preserve" stroke="#ffffff">
                                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                        <g id="SVGRepo_iconCarrier">
                                            <g>
                                ...
                                <div class="col-12 text-center"><a class="fs-5"
                                        href="{{ route('frontend.pages.services.excavator-service') }}"><button
                                            class="tj-submit-btn fs-6"> Equipment Services<i
                                                class="fa fa-arrow-left"></i></button></a>
                                </div>
                            </div>
                ...
                <div class="col-lg-4 col-md-6" data-sal="slide-up" data-sal-duration="800" data-sal-delay="300">
                    <div class="service-item-three">
                        <div class="service-image">
                            <img loading="lazy" src="{{ asset('frontend/images/service/Farm.webp') }}"
                                alt="Image" />
                        </div>
                        <div class="overlay">
                            <div class="row justify-content-center align-items-center">
                                <div class="col-12 text-center mb-3">
                                    <svg fill="#ffffff" height="75px" width="75px" version="1.1" id="Layer_1"
                                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6" data-sal="slide-up" data-sal-duration="800" data-sal-delay="300">
                    <div class="service-item-three">
                        <div class="service-image">
                            <img loading="lazy" src="{{ asset('frontend/images/service/Heavy.webp') }}"
                                alt="Image" />
                        </div>
                        <div class="overlay">
                            <div class="row justify-content-center align-items-center">
                                <div class="col-12 text-center mb-3">
                                    <svg width="75px" height="75px" viewBox="0 0 512 512"
                                ...
                                <div class="col-12 text-center"><a class="fs-5"
                                        href="{{ route('frontend.pages.services.heavy-service') }}"><button
                                            class="tj-submit-btn fs-6"> Equipment Services<i
                                                class="fa fa-arrow-left"></i></button></a>
                                </div>
                            </div>
                ...
                <div class="col-lg-4 col-md-6" data-sal="slide-up" data-sal-duration="800" data-sal-delay="300">
                    <div class="service-item-three">
                        ...
                        <div class="overlay">
                            <div class="row justify-content-center align-items-center">
                                <div class="col-12 text-center mb-3">
                                    <svg fill="#ffffff" width="75px" height="75px" viewBox="0 0 100 100"
                                ...
                                <div class="col-12 text-center"><a class="fs-5"
                                        href="{{ route('frontend.pages.services.rv-service') }}"><button
                                            class="tj-submit-btn fs-6">RV Transport Services<i
                                                class="fa fa-arrow-left"></i></button></a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row justify-content-center align-items-center">
                                <div class="col-12 text-center mb-3">
                                    <svg fill="#ffffff" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        viewBox="0 0 796.2 796.201" xml:space="preserve" stroke="#ffffff">
                                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                        <g id="SVGRepo_iconCarrier">
                                            <g>
                                                <g>
                                                    <path
                                                        d="M228.709,562.066c-26.248,0-47.501,21.264-47.501,47.504c0,26.238,21.253,47.502,47.501,47.502 c26.225,0,47.506-21.264,47.506-47.502C276.215,583.33,254.934,562.066,228.709,562.066z">
                                                    </path>
                                                    <path
                                                        d="M354.073,567.707c-26.225,0-47.504,21.269-47.504,47.505c0,26.235,21.279,47.503,47.504,47.503 c26.249,0,47.503-21.268,47.503-47.503C401.576,588.973,380.322,567.707,354.073,567.707z">
                                                    </path>
                                                    <path
                                                        d="M669.721,562.066c-26.234,0-47.5,21.264-47.5,47.504c0,26.238,21.266,47.502,47.5,47.502 c26.24,0,47.506-21.264,47.506-47.502C717.227,583.33,695.961,562.066,669.721,562.066z">
                                                    </path>
                                                    <path
                                                        d="M783.013,400.06c0-21.713-10.651-40.797-26.87-52.787c-10.906-8.064-24.297-12.998-38.916-12.998H605.943v12.998h-1.104 v166.076h-25.302h-27.485H126.426v82.501h27.493c6.456-35.471,37.445-62.372,74.79-62.372h125.364 c37.349,0,68.333,26.901,74.792,62.372H594.93c6.456-35.471,37.456-62.372,74.789-62.372c37.338,0,68.338,26.901,74.795,62.372 H796.2v-82.501h-13.188L783.013,400.06L783.013,400.06z M754.414,465.054h-84.693v-105.67h47.506c0,0,37.188,3.288,37.188,32.992 L754.414,465.054L754.414,465.054z">
                                                    </path>
                                                    <polygon
                                                        points="566.872,488.016 592.174,488.016 592.174,321.939 592.174,133.486 0,133.486 0,488.016 113.762,488.016 539.385,488.016 ">
                                                    </polygon>
                                                </g>
                                            </g>
                                        </g>
                                ...
                                <div class="col-12 text-center"><a class="fs-5"
                                        href="{{ route('frontend.pages.services.dryvan-service') }}"><button
                                            class="tj-submit-btn fs-6">Dry Van Services<i
                                                class="fa fa-arrow-left"></i></button></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="service-item-three">
                        ...
                        <div class="overlay">
                            <div class="row justify-content-center align-items-center">
                                ...
                                <div class="col-12 text-center"><a class="fs-5"
                                        href="{{ route('frontend.pages.services.hazmat-service') }}"><button
                                            class="tj-submit-btn fs-6">Hazmat Transport Services<i
                                                class="fa fa-arrow-left"></i></button></a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-6" data-sal="slide-up" data-sal-duration="800" data-sal-delay="300">
                    <div class="service-item-three">
                        ...
                        <div class="overlay">
                            <div class="row justify-content-center align-items-center">
                                <div class="col-12 text-center mb-3">
                                    <svg fill="#ffffff" width="75px" height="75px" viewBox="0 -30.87 122.88 122.88"
                                        version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                                        xmlns:xlink="http://www.w3.org/1999/xlink"
                                        style="enable-background:new 0 0 122.88 61.14" xml:space="preserve"
                                        stroke="#ffffff">
                                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                        <g id="SVGRepo_iconCarrier">
                                ...
                                <div class="col-12 text-center"><a class="fs-5"
                                        href="{{ route('frontend.pages.services.reefer-service') }}"><button
                                            class="tj-submit-btn fs-6">Reefer Transport Services<i
                                                class="fa fa-arrow-left"></i></button></a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-6" data-sal="slide-up" data-sal-duration="800" data-sal-delay="300">
                    <div class="service-item-three">
                        ...
                        <div class="overlay">
                            <div class="row justify-content-center align-items-center">
                                <div class="col-12 text-center mb-3">
                                    <svg  width="75px" height="75px" version="1.0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512.000000 512.000000"preserveAspectRatio="xMidYMid meet"><g transform="translate(0.000000,512.000000) scale(0.100000,-0.100000)"fill="#ffffff" stroke="none"><path d="M944 4219 c-17 -19 -19 -41 -22 -220 l-4 -199 -164 0 c-185 0 -223 -9 -248 -59 -13 -25 -16 -76 -16 -314 l0 -285 -131 -4 -131 -4 -29 -32 c-29 -32 -29 -33 -29 -161 0 -125 1 -129 26 -154 14 -14 35 -27 47 -29 22 -3 22 -6 25 -225 l2 -223 -82 0 c-99 0 -144 -19 -171 -70 -24 -46 -18 -100 27 -234 61 -182 171 -377 298 -531 82 -98 82 -93 -21 -304 -64 -131 -69 -158 -42 -213 41 -86 -172 -78 2076 -78 2184 0 2030 -4 2073 57 37 54 684 1446 689 1482 5 46 -21 98 -66 128 -34 23 -37 23 -388 23 -385 0 -396 -1 -457 -58 -16 -15 -37 -45 -47 -67 l-19 -40 0 234 c0 347 18 331 -388 331 l-281 0 -3 293 c-3 330 -5 337 -75 356 -41 12 -1286 16 -1342 5 -17 -4 -42 -18 -56 -32 l-25 -25 0 -628 0 -629 -120 0 -120 0 2 223 c3 221 3 222 25 225 12 2 34 17 48 33 24 29 25 36 25 155 0 122 0 124 -29 156 l-29 32 -131 4 -131 4 0 280 c0 390 8 378 -264 378 l-166 0 0 179 c0 184 -8 234 -40 251 -31 17 -76 11 -96 -11z m416 -824 l0 -255 -360 0 -360 0 0 255 0 255 360 0 360 0 0 -255z m1280 -170 l0 -255 -260 0 -260 0 0 255 0 255 260 0 260 0 0 -255z m678 -2 l2 -253 -265 0 -265 0 0 255 0 255 263 -2 262 -3 3 -252z m-1638 -283 l0 -40 -440 0 c-427 0 -441 -1 -460 -20 -35 -35 -25 -92 21 -115 23 -12 94 -15 404 -15 l375 0 0 -220 0 -220 -580 0 -580 0 0 219 0 218 45 6 c58 6 85 30 85 74 0 59 -25 73 -135 73 l-95 0 0 40 0 40 680 0 680 0 0 -40z m960 -375 l0 -255 -260 0 -260 0 0 255 0 255 260 0 260 0 0 -255z m678 -2 l2 -253 -265 0 -265 0 0 255 0 255 263 -2 262 -3 3 -252z m672 2 l0 -255 -260 0 -260 0 0 255 0 255 260 0 260 0 0 -255z m970 -149 c0 -2 -303 -649 -433 -923 l-10 -23 -385 0 c-382 0 -386 0 -409 -22 -40 -38 -25 -96 31 -118 17 -6 153 -10 357 -10 181 0 329 -4 329 -9 0 -4 -29 -69 -65 -145 l-65 -136 -1944 0 -1945 0 55 118 c31 64 60 129 66 144 l10 28 1449 2 1448 3 22 22 c27 27 29 75 4 103 -18 20 -28 20 -1480 20 l-1463 0 -18 27 c-10 16 -40 55 -68 88 -70 85 -141 195 -191 300 -42 87 -95 233 -95 261 0 12 299 14 1983 14 l1983 0 51 25 c61 31 101 86 110 152 12 86 0 83 358 83 173 0 315 -2 315 -4z" /> </g></svg>

                                </div>
                                <div class="col-12 text-center text-white mb-3">
                                    <h4 class="overlay-title">Roro Shipping International</h4>
                                </div>
                                <div class="col-12 text-center"><a class="fs-5"
                                        href="{{ route('frontend.pages.services.roro-service') }}"><button
                                            class="tj-submit-btn fs-6">Reefer Transport Services<i
                                                class="fa fa-arrow-left"></i></button></a>
                                </div>
                            </div>
